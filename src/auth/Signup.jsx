    ...
    <div className="min-h-screen grid md:grid-cols-2 overflow-hidden">
      ...
      <section className="flex items-center justify-center py-6 px-6 md:px-10 md:py-10 bg-white">
        <div className="w-full max-w-[360px]">
          ...
          <h1 className="text-2xl font-semibold text-center mt-6 mb-6">Sign up</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button 
              type="submit"
              className="w-full bg-brand text-white bg-[#00875A] font-medium rounded-lg py-2.5 hover:bg-brandDark transition shadow-sm"
            >
              Get Started
            </button>
            ...
            <button 
              type="button"
              className="w-full border border-line bg-white text-ink font-medium rounded-lg py-2.5 flex items-center justify-center gap-2 hover:bg-gray-50 transition"
            >
